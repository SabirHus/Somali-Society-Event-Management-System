  ...
  async (req, res) => {
    ...
    if (event.type === 'checkout.session.completed') {
      ...
      try {
        ...
        // Email Confirmation - don't let email failure affect webhook response
        ...
        try {
          ...
          // Log but DO NOT throw — attendees are created, webhook must return 200
          // Stripe will retry the webhook if we return non-200, causing duplicate attendees
          logger.error('Email send failed (attendees still created)', {
